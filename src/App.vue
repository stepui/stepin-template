<template>
  <stepin-config-provider :theme-config="customTheme">
    <stepin-view system-name="Stepin Template" :logo-src="logoSrc" :class="`${theme}`" :user="{
      name: 'iczer',
      avatar:
    ...
    }" @user-menu-click="userMenuClick" @setting-change="onSettingChange" @copy-config="onCopyConfig"
      ...
      <template #headerActions>
        ...
        <a class="action-item" href="https://github.com/stepui/stepin-template" target="_balnk">
          <GithubOutlined />
        </a>
        <a class="action-item" href="https://gitee.com/stepui/stepin-template" target="_blank">

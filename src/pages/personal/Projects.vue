...
<template>
  <a-card :bordered="false" class="projects rounded-xl shadow-lg">
    <template #title>
    ...
    <div class="project-list flex items-stretch justify-between">
      <a-card class="project flex-1 rounded-xl" :bordered="false" v-for="item in projectList">
        <template #cover>
          <img class="w-full h-48 rounded-xl" :src="item.img" />
        </template>
      ...
      <a-button class="flex-1 ml-lg rounded-lg text-md font-semibold" style="height: unset; border-radius: 0.5rem"
        type="dashed">
